...
int main(int argc, char * argv[])
{
  ...
  auto const arm_target_pose = [&node]{
    ...
    // msg.pose.position.x = -1.184;//home
    // msg.pose.position.y = -0.341;
    // msg.pose.position.z = 0.061;
    // msg.pose.orientation.x = 0.500;
    // msg.pose.orientation.y = -0.500;
    // msg.pose.orientation.z = 0.500;
    // msg.pose.orientation.w = 0.500;
